    ...
    <body>
        ...
        <div class="container-fluid">
            <div class="row adapta1">
                <div class="col-lg-1 col-lg-offset-8 margder">
                ...
                <?php
                if ($privilegio == -1) {
                    echo '<div class="col-lg-1 margizq txtacceder">';
                    echo '<a href="../vistas/Login.php" class="ai3"> Acceder </a>';
                } else {
                    echo '<div class="col-lg-3 margizq txtacceder">';
                    if ($privilegio == 0) {
